  ...
  SyncEntityType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'AssetMetadataV1':
          return SyncEntityType.assetMetadataV1;
        case r'AssetMetadataDeleteV1':
