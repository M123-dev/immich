...
class PersonMergeTrackerService {
  ...
  // Set of merge records that have been handled (to avoid repeated redirects)
  ...
  void recordMerge({
    required String mergedPersonId,
    required String targetPersonId,
  }) {
    _mergeForwardingMap[mergedPersonId] = targetPersonId;
    _mergeEventController.add(PersonMergeEvent(
      mergedPersonId: mergedPersonId,
      targetPersonId: targetPersonId,
    ));
  }

  /// Record multiple person merges (when merging multiple people into one)
  void recordMultipleMerges({
    required List<String> mergedPersonIds,
    required String targetPersonId,
  }) {
