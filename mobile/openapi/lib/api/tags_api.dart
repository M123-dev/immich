...
class TagsApi {
  ...
  Future<Response> bulkTagAssetsWithHttpInfo(
  ...
  Future<TagBulkAssetsResponseDto?> bulkTagAssets(
    ...
    final response = await bulkTagAssetsWithHttpInfo(
      tagBulkAssetsDto,
    );
  ...
  Future<Response> upsertTagsWithHttpInfo(
  ...
  Future<List<TagResponseDto>?> upsertTags(
    ...
    final response = await upsertTagsWithHttpInfo(
      tagUpsertDto,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
